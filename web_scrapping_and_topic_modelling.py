# -*- coding: utf-8 -*-
"""Web_Scrapping_and_Topic_Modelling.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-r3L3S3Yj9oD_HwLj8_QU0JaI06w1IHa
"""

import requests
from bs4 import BeautifulSoup

url = 'https://www.investopedia.com/terms/m/medical-expenses.asp'
...
content = soup0.find('div',class_='comp article-body-content mntl-sc-page mntl-block').text
data.append(content)
data
